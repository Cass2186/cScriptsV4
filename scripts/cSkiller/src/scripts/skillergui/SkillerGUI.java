...
public class SkillerGUI extends Application {
    ...
    public SkillerGUI(String fxml, boolean decorated) {
    ...
    public SkillerGUI(String fxml, URL stylesheet) {
    ...
    public SkillerGUI(String fxml, URL stylesheet, boolean decorated) {
...
//        stage.setAlwaysOnTop(true);
    ...
    public <T extends SkillerAbstractGUIController> T getController() {
