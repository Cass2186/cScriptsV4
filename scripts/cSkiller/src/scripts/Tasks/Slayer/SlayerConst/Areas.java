...
public  class Areas {
    ...
    public static RSArea VAMPYRE_AREA = new RSArea(new RSTile(3578,3480, 0),15);
    public static RSTile WALL_BEAST_TILE = new RSTile(3162, 9573, 0);
    public static  RSArea GOBLIN_AREA = new RSArea(
            new RSTile[] {
                    new RSTile(3239, 3250, 0),
                    new RSTile(3259, 3250, 0),
                    new RSTile(3261, 3223, 0),
                    new RSTile(3249, 3223, 0),
                    new RSTile(3242, 3235, 0)
            }
    );
    public static    RSArea OTHERWORLDLY_BEING_AREA = new RSArea(new RSTile(2376, 4434, 0), new RSTile(2393, 4416, 0));
    public static RSArea OGRE_AREA = new RSArea(new RSTile(2572, 2971, 0), new RSTile(2602, 2958, 0));
    ...
    public static RSArea JACKAL_AREA = new RSArea(
            new RSTile[] {
                    new RSTile(3321, 2938, 0),
                    new RSTile(3324, 2921, 0),
                    new RSTile(3335, 2925, 0),
                    new RSTile(3335, 2929, 0),
                    new RSTile(3349, 2930, 0),
                    new RSTile(3349, 2940, 0),
                    new RSTile(3334, 2942, 0)
            }
    );
    ...
    public static  RSArea ICE_WARRIOR_AREA = new RSArea(
            new RSTile[] {
                    new RSTile(3038, 9586, 0),
                    new RSTile(3043, 9593, 0),
                    new RSTile(3050, 9593, 0),
                    new RSTile(3050, 9572, 0),
                    new RSTile(3044, 9572, 0),
                    new RSTile(3039, 9575, 0)
            }
    );
   ...
   public static  RSArea MOSS_GIANT_AREA = new RSArea(
           new RSTile[] {
                   ...
                   new RSTile(1674, 10015, 0),
                   new RSTile(1675, 10008, 0),
                   new RSTile(1672, 10006, 0),
                   new RSTile(1670, 10006, 0),
                   new RSTile(1666, 10003, 0),
                   new RSTile(1664, 10003, 0),
                   new RSTile(1662, 10005, 0),
                   new RSTile(1657, 10002, 0),
                   new RSTile(1650, 10002, 0),
                   new RSTile(1650, 10008, 0),
                   new RSTile(1654, 10011, 0),
                   new RSTile(1654, 10015, 0),
                   new RSTile(1660, 10016, 0),
