...
public class AgilityAreas {
    ...
    public static  RSArea POLV_HOUSE_AREA = new RSArea(
            new RSTile[] {
                    new RSTile(3352, 2969, 0),
                    new RSTile(3352, 2963, 0),
                    new RSTile(3348, 2963, 0),
                    new RSTile(3347, 2964, 0),
                    new RSTile(3346, 2964, 0),
                    new RSTile(3346, 2969, 0)
            }
    );
    /**
     * RELLEKA
