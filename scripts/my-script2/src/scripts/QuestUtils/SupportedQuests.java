...
public enum SupportedQuests {
    ...
    ALFRED_GRIMHANDS_BARCRAWL(322, 77, false, BarCrawl.get()),
    ANIMAL_MAGNETISM(331, 3185, true, AnimalMagnetism.get()),
    A_PORCINE_OF_INTEREST(3151, 10582, true, APorcineOfInterest.get()),
    BIG_CHOMPY_BIRD_HUNTING(334, 293, false, BigChompyBirdHunting.get()),
    BIOHAZARD(335, 68, false, Biohazard.get()),
    BLACK_KNIGHTS_FORTRESS(299, 130, false, BlackKnightsFortress.get()),
    BONE_VOYAGE(3135, 5795, true, BoneVoyage.get()),
    CLIENT_OF_KOUREND(3136, 5619, true, ClientOfKourend.get()),
    CONTACT(339, 3274, true, Contact.get()),
    COOKS_ASSISTANT(300, 29, false, CooksAssistant.get()),
    DEATH_PLATEAU(342, 314, false, DeathPlateau.get()),
   ...
   // THE_CORSAIR_CURSE(301, 6071, true),
    ...
    ZOGRE_FLESH_EATERS(449, 487, true, ZogreFleshEaters.get()),
