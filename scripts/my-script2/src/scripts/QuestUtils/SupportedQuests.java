...
public enum SupportedQuests {
   ...
   PIRATES_TREASURE(310, 71, false, Quest.PIRATES_TREASURE, 2),
    ...
    FAIRYTALE_I_GROWING_PAINS(359, 1803, true, Quest.FAIRYTALE_I__GROWING_PAINS, 2), //, FairyTalePt1.get()),
    ...
    ROMEO_JULIET(313, 144, false, Quest.ROMEO__JULIET, 5), //, RomeoAndJuliet.get()),
