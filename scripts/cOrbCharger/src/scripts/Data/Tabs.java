...
public enum Tabs {
    ...
    ENCHANT_DIAMOND(57,
            List.of(
                    new ItemReq(ItemID.STAFF_OF_EARTH, 1, true, true),
    ...
    CAMELOT(45, List.of(new ItemReq(ItemID.LAW_RUNE, 1)),
            55, "Camelot Teleport", ItemID.CAMELOT_TELEPORT),
    ARDOUGNE(51, List.of(
            new ItemReq(ItemID.WATER_RUNE, 2),
            new ItemReq(ItemID.LAW_RUNE, 2)),
    ...
    public boolean canCraftTab() {
        return runeReqs.stream().anyMatch(r -> !r.check()) &&
